...
import { createTurbine, deleteTurbine, listTurbines, updateTurbine, } from '../services/turbine.service';
...
describe('turbine.service', () => {
    ...
    it('lists with pagination + filter', async () => {
        ...
        expect(turbineMocks.findMany).toHaveBeenCalledWith(expect.objectContaining({
