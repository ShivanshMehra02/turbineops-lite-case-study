...
import {
  repairPlanGenerateRestSchema,
  repairPlanInspectionParamsSchema,
} from '../../validators/repair-plan.validator';

export function createRepairPlansRouter(mongoClient: MongoClient | null, mongoDbName: string): Router {
  const router = Router();
