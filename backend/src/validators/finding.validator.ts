...
export const findingUpdateRestSchema = z
  ...
  .transform((v) => {
    ...
    if (v.severity !== undefined) out.severity = v.severity;
    if (v.estimated_cost !== undefined) out.estimatedCost = v.estimated_cost;
...
export type FindingCreateInput = z.infer<typeof findingCreateBodySchema>;
export type FindingUpdateInput = z.infer<typeof findingUpdateBodySchema>;
