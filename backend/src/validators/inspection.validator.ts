...
function normalizedRawPackageUrl(value: string | null | '' | undefined): string | null | undefined {
...
export const inspectionCreateBodySchema = z
  ...
  .transform((v) => {
    ...
    if (v.inspectorName !== undefined) out.inspectorName = v.inspectorName;
    const url = normalizedRawPackageUrl(v.rawPackageUrl);
    if (url !== undefined) out.rawPackageUrl = url;
    return out;
  });
...
export const inspectionCreateRestSchema = z
  ...
  .transform((v) => {
    ...
    if (v.inspector_name !== undefined) out.inspectorName = v.inspector_name;
...
export const inspectionUpdateBodySchema = z
  ...
  .transform((v) => {
    ...
    if (v.turbineId !== undefined) out.turbineId = v.turbineId;
    if (v.date !== undefined) out.date = v.date;
    if (v.inspectorName !== undefined) out.inspectorName = v.inspectorName;
...
export const inspectionUpdateRestSchema = z
  ...
  .transform((v) => {
    ...
    if (v.turbine_id !== undefined) out.turbineId = v.turbine_id;
    if (v.date !== undefined) out.date = v.date;
    if (v.inspector_name !== undefined) out.inspectorName = v.inspector_name;
    if (v.data_source !== undefined) out.dataSource = v.data_source;
    const url = normalizedRawPackageUrl(v.raw_package_url);
    if (url !== undefined) out.rawPackageUrl = url;
    return out;
  })
...
export type InspectionUpdateInput = z.infer<typeof inspectionUpdateBodySchema>;
